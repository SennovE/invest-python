...
from tinkoff.invest.grpc.marketdata import TradeDirection
...
class GetFavoriteGroupsResponse:
    ...
    class FavoriteGroup:
        ...
        color: str
        size: int
        contains_instrument: Optional[bool] = None
...
class RiskRatesResponse:
    ...
    class RiskRateResult:
        instrument_uid: str
        short_risk_rates: List['RiskRate']
        long_risk_rates: List['RiskRate']
        short_risk_rate: Optional['RiskRate'] = None
        long_risk_rate: Optional['RiskRate'] = None
...
class GetInsiderDealsResponse:
    ...
    class InsiderDeal:
        ...
        ticker: str
        investor_name: str
        investor_position: str
        percentage: float
        is_option_execution: bool
